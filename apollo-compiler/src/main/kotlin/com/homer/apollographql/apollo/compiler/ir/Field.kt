...
import com.homer.apollographql.apollo.compiler.SchemaTypeSpecBuilder
import com.homer.apollographql.apollo.compiler.escapeJavaReservedWord
import com.homer.apollographql.apollo.compiler.singularize
...
import com.homer.apollographql.apollo.compiler.toJavaBeansSemanticNaming
import com.homer.apollographql.apollo.compiler.withBuilder
          ...
          when (value) {
            is Number -> {
              when (ScalarType.forName(type.removeSuffix("!"))) {
                is INT -> CodeBlock.of(".put(\$S, \$L)\n", name, value.toInt())
                is FLOAT -> CodeBlock.of(".put(\$S, \$Lf)\n", name, value.toDouble())
