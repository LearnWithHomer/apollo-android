package com.homer.apollographql.apollo.compiler.parser.graphql

import com.homer.apollographql.apollo.compiler.PackageNameProvider
import com.homer.apollographql.apollo.compiler.ir.Argument
import com.homer.apollographql.apollo.compiler.ir.Condition
...
import com.homer.apollographql.apollo.compiler.ir.InlineFragment
...
import com.homer.apollographql.apollo.compiler.ir.Variable
import com.homer.apollographql.apollo.compiler.parser.antlr.GraphQLLexer
import com.homer.apollographql.apollo.compiler.parser.antlr.GraphQLParser
...
import com.homer.apollographql.apollo.compiler.parser.graphql.GraphQLDocumentSourceBuilder.graphQLDocumentSource
...
import com.homer.apollographql.apollo.compiler.parser.introspection.isAssignableFrom
import com.homer.apollographql.apollo.compiler.parser.introspection.possibleTypes
import com.homer.apollographql.apollo.compiler.parser.introspection.resolveType
  ...
  private fun GraphQLParser.VariableDefinitionContext.parse(): ParseResult<Variable> {
    ...
    return ParseResult(
        result = Variable(
            name = name,
            type = type,
            // parse doesn't work with nullable types (see https://github.com/homer.apollographql/apollo-android/issues/2742)
