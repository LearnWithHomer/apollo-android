...
public interface GraphQLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#fragmentKeyword}.
	 * @param ctx the parse tree
	 */
	void enterFragmentKeyword(GraphQLParser.FragmentKeywordContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#fragmentKeyword}.
	 * @param ctx the parse tree
	 */
	void exitFragmentKeyword(GraphQLParser.FragmentKeywordContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#arrayValueType}.
	 * @param ctx the parse tree
	 */
	void enterArrayValueType(GraphQLParser.ArrayValueTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#arrayValueType}.
	 * @param ctx the parse tree
	 */
	void exitArrayValueType(GraphQLParser.ArrayValueTypeContext ctx);
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#emptyArray}.
	 * @param ctx the parse tree
	 */
	void enterEmptyArray(GraphQLParser.EmptyArrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#emptyArray}.
	 * @param ctx the parse tree
	 */
	void exitEmptyArray(GraphQLParser.EmptyArrayContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GraphQLParser#emptyMap}.
	 * @param ctx the parse tree
	 */
	void enterEmptyMap(GraphQLParser.EmptyMapContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#emptyMap}.
	 * @param ctx the parse tree
	 */
	void exitEmptyMap(GraphQLParser.EmptyMapContext ctx);
	/**
