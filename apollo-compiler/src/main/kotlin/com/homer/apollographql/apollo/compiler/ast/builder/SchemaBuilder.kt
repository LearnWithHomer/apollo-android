...
import com.homer.apollographql.apollo.compiler.ast.Schema
...
internal fun CodeGenerationIR.ast(
  ...
  val enums = typeDeclarations.filter {
    it.kind == com.homer.apollographql.apollo.compiler.ir.TypeDeclaration.KIND_ENUM
  ...
  val inputTypes = typeDeclarations.filter {
    it.kind == com.homer.apollographql.apollo.compiler.ir.TypeDeclaration.KIND_INPUT_OBJECT_TYPE
