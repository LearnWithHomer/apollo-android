...
class VariablesTypeSpecBuilder(
  ...
  private fun valueMapFieldSpec(): FieldSpec {
    return FieldSpec.builder(
        ClassNames.parameterizedMapOf(java.lang.String::class.java, Object::class.java),
  ...
  private fun Variable.javaTypeName(context: CodeGenerationContext): TypeName {
    return JavaTypeResolver(context.copy(nullableValueType = INPUT_TYPE), context.ir.typesPackageName)
        .resolve(type)
  }
