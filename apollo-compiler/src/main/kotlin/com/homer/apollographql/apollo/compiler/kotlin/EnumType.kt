...
private fun EnumType.toEnumTypeSpec(generateAsInternal: Boolean): TypeSpec {
  return TypeSpec
      ...
      .primaryConstructor(
          com.homer.apollographql.apollo.compiler.kotlin.primaryConstructorWithOverriddenParamSpec
      )
      .addSuperinterface(EnumValue::class)
      .addProperty(com.homer.apollographql.apollo.compiler.kotlin.rawValuePropertySpec)
      .apply {
        values.forEach { value -> addEnumConstant(value.constName, value.enumConstTypeSpec) }
        addEnumConstant("UNKNOWN__",
            com.homer.apollographql.apollo.compiler.kotlin.unknownEnumConstTypeSpec
        )
      }
...
private val EnumType.Value.enumConstTypeSpec: TypeSpec
  get() {
    return TypeSpec
        ...
        .applyIf(description.isNotBlank()) { addKdoc("%L\n", description) }
        .applyIf(deprecationReason != null) { addAnnotation(
            com.homer.apollographql.apollo.compiler.kotlin.KotlinCodeGen.deprecatedAnnotation(
                deprecationReason!!
            )
        ) }
...
private val EnumType.unknownValueTypeSpec: TypeSpec
  get() {
    return TypeSpec.classBuilder("UNKNOWN__")
        .addKdoc("%L", "Auto generated constant for unknown enum values\n")
        .primaryConstructor(com.homer.apollographql.apollo.compiler.kotlin.primaryConstructorSpec)
