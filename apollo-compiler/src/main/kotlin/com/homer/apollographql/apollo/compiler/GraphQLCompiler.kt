...
import com.homer.apollographql.apollo.compiler.ApolloMetadata.Companion.merge
import com.homer.apollographql.apollo.compiler.kotlin.GraphQLKompiler
...
import com.homer.apollographql.apollo.compiler.ir.Field
import com.homer.apollographql.apollo.compiler.ir.IRBuilder
import com.homer.apollographql.apollo.compiler.ir.ScalarType
...
import com.homer.apollographql.apollo.compiler.operationoutput.toJson
...
import com.homer.apollographql.apollo.compiler.NullableValueType.ANNOTATED
import com.homer.apollographql.apollo.compiler.OperationIdGenerator.Sha256
import com.homer.apollographql.apollo.compiler.OperationOutputGenerator.DefaultOperationOuputGenerator
...
import com.homer.apollographql.apollo.compiler.parser.introspection.IntrospectionSchema.Companion.toIntrospectionSchema
...
class GraphQLCompiler(val logger: Logger = NoOpLogger) {
  ...
  fun write(args: Arguments) {
    ...
    if (args.generateMetadata) {
      val outgoingMetadata = ApolloMetadata(
          ...
          pluginVersion = com.homer.apollographql.apollo.compiler.VERSION
      ).let {
  ...
  private fun CodeGenerationIR.writeJavaFiles(context: CodeGenerationContext, outputDir: File) {
    fragments.filter {
      ...
      JavaFile
          ...
          .addFileComment(
              com.homer.apollographql.apollo.compiler.GraphQLCompiler.AUTO_GENERATED_FILE
          )
          .build()
          .writeTo(outputDir)
    }
  ...
  data class Arguments(
       ...
       */
      val operationOutputGenerator: OperationOutputGenerator = DefaultOperationOuputGenerator(
          Sha256()
      ),
      ...
      val nullableValueType: NullableValueType = ANNOTATED,
