...
import com.homer.apollographql.apollo.compiler.ClassNames.parameterizedGuavaOptional
import com.homer.apollographql.apollo.compiler.ClassNames.parameterizedInputType
import com.homer.apollographql.apollo.compiler.ClassNames.parameterizedJavaOptional
import com.homer.apollographql.apollo.compiler.ClassNames.parameterizedOptional
...
import com.homer.apollographql.apollo.compiler.NullableValueType.APOLLO_OPTIONAL
import com.homer.apollographql.apollo.compiler.NullableValueType.GUAVA_OPTIONAL
import com.homer.apollographql.apollo.compiler.NullableValueType.INPUT_TYPE
import com.homer.apollographql.apollo.compiler.NullableValueType.JAVA_OPTIONAL
    ...
    return when {
      ...
      isOptional -> {
        when (nullableValueType ?: context.nullableValueType) {
          APOLLO_OPTIONAL -> parameterizedOptional(javaType)
          GUAVA_OPTIONAL -> parameterizedGuavaOptional(javaType)
          JAVA_OPTIONAL -> parameterizedJavaOptional(javaType)
          INPUT_TYPE -> parameterizedInputType(javaType)
