...
import com.homer.apollographql.apollo.compiler.VisitorSpec.VISITOR_CLASSNAME
import com.homer.apollographql.apollo.compiler.ir.CodeGenerationContext
import com.homer.apollographql.apollo.compiler.ir.CodeGenerator
    ...
    return MethodSpec.methodBuilder("wrapData")
        ...
        .addStatement(
            when {
              ...
              context.nullableValueType != ANNOTATED -> "return Optional.fromNullable(data)"
              else -> "return data"
            })
        .build()
  }
      ...
      return operation.variables
          .map { variable ->
            variable.name.decapitalize() to JavaTypeResolver(
                context.copy(nullableValueType = INPUT_TYPE),
