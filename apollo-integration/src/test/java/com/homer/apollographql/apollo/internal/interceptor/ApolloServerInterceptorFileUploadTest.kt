package com.homer.apollographql.apollo.internal.interceptor

import com.homer.apollographql.apollo.Utils.checkTestFixture
import com.homer.apollographql.apollo.api.CustomTypeAdapter
import com.homer.apollographql.apollo.api.FileUpload
...
import com.homer.apollographql.apollo.integration.upload.MultipleUploadMutation
import com.homer.apollographql.apollo.integration.upload.NestedUploadMutation
import com.homer.apollographql.apollo.integration.upload.SingleUploadMutation
import com.homer.apollographql.apollo.integration.upload.SingleUploadTwiceMutation
import com.homer.apollographql.apollo.integration.upload.type.NestedObject
...
class ApolloServerInterceptorFileUploadTest {
  ...
  private val nestedObject0 = NestedObject.builder()
      .file(upload0)
      .fileList(listOf(upload1, upload2))
      .build()

  private val nestedObject1 = NestedObject.builder()
      .file(upload1)
      .fileList(listOf(upload0, upload2))
      .build()

  private val nestedObject2 = NestedObject.builder()
      .file(upload2)
      .fileList(listOf(upload0, upload1))
      .recursiveNested(listOf(nestedObject0, nestedObject1))
      .build()

  private val mutationSingle = SingleUploadMutation.builder()
      .file(upload1)
      .build()

  private val mutationSource = SingleUploadMutation.builder()
      .file(uploadSource)
      .build()

  private val mutationTwice = SingleUploadTwiceMutation.builder()
      .file1(upload1)
      .file2(upload2)
      .build()
  ...
  private val mutationNested = NestedUploadMutation.builder()
  ...
  fun testDefaultHttpCallWithUploadSingle() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ApolloLogger(null))
    interceptor.httpPostCall(mutationSingle, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testDefaultHttpCallWithUploadSource() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ScalarTypeAdapters(emptyMap<ScalarType, CustomTypeAdapter<*>>()),
        ApolloLogger(null))
    interceptor.httpPostCall(mutationSource, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testDefaultHttpCallWithUploadTwice() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ScalarTypeAdapters(emptyMap<ScalarType, CustomTypeAdapter<*>>()),
        ApolloLogger(null))
    interceptor.httpPostCall(mutationTwice, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testDefaultHttpCallWithUploadMultiple() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ScalarTypeAdapters(emptyMap<ScalarType, CustomTypeAdapter<*>>()),
        ApolloLogger(null))
    interceptor.httpPostCall(mutationMultiple, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testDefaultHttpCallWithUploadNested() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ScalarTypeAdapters(emptyMap<ScalarType, CustomTypeAdapter<*>>()),
        ApolloLogger(null))
    interceptor.httpPostCall(mutationNested, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testAdditionalHeaders() {
    ...
    val requestHeaders: com.homer.apollographql.apollo.request.RequestHeaders = com.homer.apollographql.apollo.request.RequestHeaders.builder()
