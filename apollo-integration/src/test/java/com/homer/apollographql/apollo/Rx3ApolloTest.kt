...
import com.homer.apollographql.apollo.integration.normalizer.type.Episode.EMPIRE
import com.homer.apollographql.apollo.integration.normalizer.type.Episode.NEWHOPE
import com.homer.apollographql.apollo.rx3.Rx3Apollo
...
class Rx3ApolloTest {
  ...
  fun callProducesValue() {
    ...
    com.homer.apollographql.apollo.rx3.Rx3Apollo
  ...
  fun callIsCanceledWhenDisposed() {
    ...
    val disposable: Disposable = com.homer.apollographql.apollo.rx3.Rx3Apollo
        .from(apolloClient.query(EpisodeHeroNameQuery(Input.fromNullable(EMPIRE))))
  ...
  fun disposingAnOperationDoesNotThrowUndeliverableException() {
    ...
    val testObserver = com.homer.apollographql.apollo.rx3.Rx3Apollo.from(operation)
        .test()
