...
class ApolloServerInterceptorTest {
  ...
  fun testDefaultHttpCall() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ApolloLogger(null))
    interceptor.httpPostCall(query, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testCachedHttpCall() {
    ...
    interceptor.httpPostCall(query, CacheHeaders.builder().addHeader(ApolloCacheHeaders.DO_NOT_STORE, "true").build(),
        com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, false)
  }
  ...
  fun testUseHttpGetForQueries() {
    ...
    val interceptor = ApolloServerInterceptor(serverUrl,
        ...
        ScalarTypeAdapters(emptyMap<ScalarType, CustomTypeAdapter<*>>()),
        ApolloLogger(null))
    interceptor.httpGetCall(query, CacheHeaders.NONE, com.homer.apollographql.apollo.request.RequestHeaders.NONE, true, true)
  }
