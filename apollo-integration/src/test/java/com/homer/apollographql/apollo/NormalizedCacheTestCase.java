...
import com.homer.apollographql.apollo.integration.normalizer.CharacterDetailsQuery;
import com.homer.apollographql.apollo.integration.normalizer.CharacterNameByIdQuery;
import com.homer.apollographql.apollo.integration.normalizer.EpisodeHeroNameQuery;
import com.homer.apollographql.apollo.integration.normalizer.HeroAndFriendsDirectivesQuery;
...
import com.homer.apollographql.apollo.integration.normalizer.StarshipByIdQuery;
import com.homer.apollographql.apollo.integration.normalizer.fragment.HeroWithFriendsFragment;
import com.homer.apollographql.apollo.integration.normalizer.fragment.HumanWithIdFragment;
...
import static com.homer.apollographql.apollo.fetcher.ApolloResponseFetchers.CACHE_FIRST;
...
public class NormalizedCacheTestCase {
  ...
  @Test public void masterDetailSuccess() throws Exception {
    Utils.INSTANCE.enqueueAndAssertResponse(
        ...
        "HeroAndFriendsNameWithIdsResponse.json",
        apolloClient.query(new HeroAndFriendsNamesWithIDsQuery(Input.fromNullable(Episode.NEWHOPE)))
            .responseFetcher(ApolloResponseFetchers.NETWORK_ONLY), new Predicate<Response<HeroAndFriendsNamesWithIDsQuery.Data>>() {
          @Override public boolean test(Response<HeroAndFriendsNamesWithIDsQuery.Data> response) throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new CharacterNameByIdQuery("1002")).responseFetcher(
  ...
  @Test public void masterDetailFailIncomplete() throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new CharacterDetailsQuery("1002")).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
  ...
  @Test public void cacheOnlyMissReturnsNullData() throws Exception {
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new EpisodeHeroNameQuery(Input.fromNullable(Episode.EMPIRE))).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<EpisodeHeroNameQuery.Data>>() {
          @Override public boolean test(Response<EpisodeHeroNameQuery.Data> response) throws Exception {
  ...
  @Test public void cacheResponseWithNullableFields() throws Exception {
    Utils.INSTANCE.enqueueAndAssertResponse(
        server,
        "AllPlanetsNullableField.json",
        apolloClient.query(new AllPlanetsQuery()).responseFetcher(
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new AllPlanetsQuery()).responseFetcher(ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<AllPlanetsQuery.Data>>() {
          @Override public boolean test(Response<AllPlanetsQuery.Data> response) throws Exception {
            assertThat(response).isNotNull();
            assertThat(response.hasErrors()).isFalse();
  ...
  @Test public void removeFromStore() throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new HeroAndFriendsNamesWithIDsQuery(Input.fromNullable(Episode.NEWHOPE)))
            .responseFetcher(ApolloResponseFetchers.CACHE_ONLY), new Predicate<Response<HeroAndFriendsNamesWithIDsQuery.Data>>() {
          @Override public boolean test(Response<HeroAndFriendsNamesWithIDsQuery.Data> response) throws Exception {
            assertThat(response.fromCache()).isTrue();
            assertThat(response.data()).isNull();
            return true;
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new CharacterNameByIdQuery("1003")).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<CharacterNameByIdQuery.Data>>() {
          @Override public boolean test(Response<CharacterNameByIdQuery.Data> response) throws Exception {
            assertThat(response.fromCache()).isTrue();
  ...
  @Test public void removeMultipleFromStore() throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new CharacterNameByIdQuery("1000")).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<CharacterNameByIdQuery.Data>>() {
          @Override public boolean test(Response<CharacterNameByIdQuery.Data> response) throws Exception {
            assertThat(response.fromCache()).isTrue();
  ...
  @Test public void skipIncludeDirective() throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(HeroAndFriendsDirectivesQuery.builder().episode(Episode.JEDI).includeName(true).skipFriends(false).build()).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<HeroAndFriendsDirectivesQuery.Data>>() {
          @Override public boolean test(Response<HeroAndFriendsDirectivesQuery.Data> response) throws Exception {
            assertThat(response.data().hero().name()).isEqualTo("R2-D2");
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(HeroAndFriendsDirectivesQuery.builder().episode(Episode.JEDI).includeName(false).skipFriends(false).build()).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<HeroAndFriendsDirectivesQuery.Data>>() {
          @Override public boolean test(Response<HeroAndFriendsDirectivesQuery.Data> response) throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(HeroAndFriendsDirectivesQuery.builder().episode(Episode.JEDI).includeName(true).skipFriends(true).build()).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<HeroAndFriendsDirectivesQuery.Data>>() {
          @Override public boolean test(Response<HeroAndFriendsDirectivesQuery.Data> response) throws Exception {
            assertThat(response.data().hero().name()).isEqualTo("R2-D2");
  ...
  @Test public void listOfList() throws Exception {
    ...
    Utils.INSTANCE.assertResponse(
        apolloClient.query(new StarshipByIdQuery("Starship1")).responseFetcher(
            ApolloResponseFetchers.CACHE_ONLY),
        new Predicate<Response<StarshipByIdQuery.Data>>() {
          @Override public boolean test(Response<StarshipByIdQuery.Data> response) throws Exception {
            assertThat(response.data().starship().__typename()).isEqualTo("Starship");
