...
public class ApolloInterceptorTest {
  ...
  public void asyncApplicationInterceptorCanShortCircuitResponses() throws Exception {
    ...
    final ApolloInterceptor.InterceptorResponse expectedResponse = prepareInterceptorResponse(query);
  ...
  public void asyncApplicationInterceptorRewritesResponsesFromServer() throws Exception {
    server.enqueue(mockResponse(FILE_EPISODE_HERO_NAME_WITH_ID));
    EpisodeHeroNameQuery query = createHeroNameQuery();
    final ApolloInterceptor.InterceptorResponse rewrittenResponse = prepareInterceptorResponse(query);
    ApolloInterceptor interceptor = new ApolloInterceptor() {
      @Override
      public void interceptAsync(@NotNull InterceptorRequest request, @NotNull
  ...
  @NotNull private ApolloInterceptor.InterceptorResponse prepareInterceptorResponse(EpisodeHeroNameQuery query) {
    ...
    return new ApolloInterceptor.InterceptorResponse(okHttpResponse,
  ...
  @NotNull private static ApolloInterceptor createShortcutInterceptor(final ApolloInterceptor.InterceptorResponse expectedResponse) {
    return new ApolloInterceptor() {
      @Override
      public void interceptAsync(@NotNull InterceptorRequest request, @NotNull ApolloInterceptorChain chain,
          @NotNull Executor dispatcher, @NotNull CallBack callBack) {
