...
object Utils {
  ...
  fun <T> assertResponse(call: com.homer.apollographql.apollo.ApolloCall<T>, predicate: Predicate<Response<T>>) {
    com.homer.apollographql.apollo.rx2.Rx2Apollo.from(call)
        .test()
        .assertValue(predicate)
  }

  @Throws(Exception::class)
  fun <T> enqueueAndAssertResponse(server: MockWebServer, mockResponse: String, call: com.homer.apollographql.apollo.ApolloCall<T>,
  ...
  @Throws(Exception::class)
  fun <T> cacheAndAssertCachedResponse(server: MockWebServer, mockResponse: String, call: com.homer.apollographql.apollo.ApolloQueryCall<T>,
                                       predicate: Predicate<Response<T>>) {
    server.enqueue(mockResponse(mockResponse))
    assertResponse(
