...
class Rx2ApolloTest {
  ...
  fun callProducesValue() {
    ...
    com.homer.apollographql.apollo.rx2.Rx2Apollo
  ...
  fun callIsCanceledWhenDisposed() {
    ...
    val disposable: Disposable = com.homer.apollographql.apollo.rx2.Rx2Apollo
        .from(apolloClient.query(EpisodeHeroNameQuery(Input.fromNullable(EMPIRE))))
  ...
  fun disposingAnOperationDoesNotThrowUndeliverableException() {
    ...
    val testObserver = com.homer.apollographql.apollo.rx2.Rx2Apollo.from(operation)
        .test()
