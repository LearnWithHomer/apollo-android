...
class CacheKeyBuilderTest {
  ...
  fun testFieldWithArgument() {
    val arguments = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        1
    )
        .put("episode", "JEDI")
        .build()
  ...
  fun testFieldWithVariableArgument() {
    val argument = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        1
    )
        .put("episode", com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any>(
            2
        )
            .put("kind", "Variable")
  ...
  fun testFieldWithMultipleArgument() {
    val build = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        1
    )
        .put("episode", "JEDI")
        .put("color", "blue")
  ...
  fun testFieldWithMultipleArgumentsOrderIndependent() {
    ...
    val fieldTwoArguments = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        1
    )
        .put("color", "blue")
        .put("episode", "JEDI")
  ...
  fun testFieldWithNestedObject() {
    val arguments = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        ...
        .put("episode", "JEDI")
        .put("nested", com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any>(
            2
        )
            .put("foo", 1)
            .put("bar", 2)
  ...
  fun testFieldWithNonPrimitiveValue() {
    val field = forString("hero", "hero", com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        1
    )
  ...
  fun testFieldWithNestedObjectAndVariables() {
    val arguments = com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any?>(
        ...
        .put("nested", com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any>(
            ...
            .put("foo", com.homer.apollographql.apollo.api.internal.UnmodifiableMapBuilder<String, Any>(
                2
            )
                .put("kind", "Variable")
