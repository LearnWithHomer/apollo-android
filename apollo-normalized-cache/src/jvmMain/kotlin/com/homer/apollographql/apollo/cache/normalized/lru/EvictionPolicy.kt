...
/**
 * Controls how long a [com.homer.apollographql.apollo.cache.normalized.Record] will
...
class EvictionPolicy internal constructor(
  ...
  fun maxSizeBytes(): com.homer.apollographql.apollo.api.internal.Optional<Long> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(maxSizeBytes)

  @Deprecated("Use property instead", replaceWith = ReplaceWith("maxEntries"))
  fun maxEntries(): com.homer.apollographql.apollo.api.internal.Optional<Long> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(maxEntries)

  @Deprecated("Use property instead", replaceWith = ReplaceWith("expireAfterAccess"))
  fun expireAfterAccess(): com.homer.apollographql.apollo.api.internal.Optional<Long> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(expireAfterAccess)

  @Deprecated("Use property instead", replaceWith = ReplaceWith("expireAfterAccessTimeUnit"))
  fun expireAfterAccessTimeUnit(): com.homer.apollographql.apollo.api.internal.Optional<TimeUnit> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(expireAfterAccessTimeUnit)

  @Deprecated("Use property instead", replaceWith = ReplaceWith("expireAfterWrite"))
  fun expireAfterWrite(): com.homer.apollographql.apollo.api.internal.Optional<Long> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(expireAfterWrite)

  @Deprecated("Use property instead", replaceWith = ReplaceWith("expireAfterWriteTimeUnit"))
  fun expireAfterWriteTimeUnit(): com.homer.apollographql.apollo.api.internal.Optional<TimeUnit> = com.homer.apollographql.apollo.api.internal.Optional.fromNullable(expireAfterWriteTimeUnit)
