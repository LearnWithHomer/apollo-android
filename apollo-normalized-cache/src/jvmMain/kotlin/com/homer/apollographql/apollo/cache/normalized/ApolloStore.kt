package com.homer.apollographql.apollo.cache.normalized
...
import com.homer.apollographql.apollo.cache.normalized.internal.NoOpApolloStore
...
/**
 * ApolloStore exposes a thread-safe api to access a [com.homer.apollographql.apollo.cache.normalized.NormalizedCache].
...
interface ApolloStore {
  ...
  /**
   * Write operation to the store and publish changes of [Record] which have changed, that will notify any [com.homer.apollographql.apollo.ApolloQueryWatcher] that depends on these [Record] to re-fetch.
   *
   * @param operation     [Operation] response data of which should be written to the store
   * @param operationData [Operation.Data] operation response data to be written to the store
   * @param <D>           type of GraphQL operation data
   ...
   * notify any [com.homer.apollographql.apollo.ApolloQueryWatcher] that depends on these [Record] to re-fetch.
   *
   * @param operation     [Operation] response data of which should be written to the store
   * @param operationData [Operation.Data] operation response data to be written to the store
   * @param mutationId    mutation unique identifier
