...
class WebSocketSubscriptionTransportTest {
  ...
  fun setUp() {
    ...
    subscriptionTransport = factory.create(object : com.homer.apollographql.apollo.subscription.SubscriptionTransport.Callback {
  ...
  fun send() {
    ...
    subscriptionTransport = WebSocketSubscriptionTransport(webSocketRequest, webSocketFactory, object : com.homer.apollographql.apollo.subscription.SubscriptionTransport.Callback {
      override fun onConnected() {}
      override fun onFailure(t: Throwable) {
