...
public class ApolloAutoPersistedOperationInterceptorTest {
        ...
        if (proceedAsyncInvocationCount == 1) {
          ...
          callBack.onResponse(
              new ApolloInterceptor.InterceptorResponse(
                  mockHttpResponse(),
                  com.homer.apollographql.apollo.api.Response.<MockOperation.Data>builder(new MockOperation())
                      .errors(
  ...
  static class MockOperation implements Operation<MockOperation.Data, MockOperation.Data, Operation.Variables> {
    ...
    @NotNull @Override public com.homer.apollographql.apollo.api.Response<Data> parse(@NotNull BufferedSource source) {
      throw new UnsupportedOperationException();
    }

    @NotNull @Override public com.homer.apollographql.apollo.api.Response<Data> parse(
    ...
    @NotNull @Override public com.homer.apollographql.apollo.api.Response parse(@NotNull ByteString byteString) {
      throw new UnsupportedOperationException();
    }

    @NotNull @Override public com.homer.apollographql.apollo.api.Response parse(
