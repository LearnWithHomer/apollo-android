...
import com.homer.apollographql.apollo.internal.util.Cancelable;
...
public interface ApolloCall<T> extends Cancelable {
   ...
   * {@link com.homer.apollographql.apollo.ApolloCall.Callback} will be disposed, and will receive no more events.
