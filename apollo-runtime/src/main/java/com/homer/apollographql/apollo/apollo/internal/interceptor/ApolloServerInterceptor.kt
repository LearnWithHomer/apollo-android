package com.homer.apollographql.apollo.apollo.internal.interceptor
...
import com.homer.apollographql.apollo.apollo.interceptor.ApolloInterceptor.CallBack
import com.homer.apollographql.apollo.apollo.interceptor.ApolloInterceptor.FetchSourceType
import com.homer.apollographql.apollo.apollo.interceptor.ApolloInterceptor.InterceptorRequest
import com.homer.apollographql.apollo.apollo.interceptor.ApolloInterceptor.InterceptorResponse
...
class ApolloServerInterceptor(serverUrl: HttpUrl, httpCallFactory: Call.Factory,
  ...
  fun httpGetCall(operation: Operation<*, *, *>, cacheHeaders: CacheHeaders, requestHeaders: RequestHeaders,
    ...
    val requestBuilder = Request.Builder()
        .url(
            httpGetUrl(serverUrl, operation, scalarTypeAdapters, writeQueryDocument, autoPersistQueries)
        )
        .get()
  ...
  fun httpPostCall(operation: Operation<*, *, *>, cacheHeaders: CacheHeaders, requestHeaders: RequestHeaders,
    ...
    var requestBody = RequestBody.create(
        MEDIA_TYPE, httpPostRequestBody(operation, scalarTypeAdapters,
  ...
  fun decorateRequest(requestBuilder: Request.Builder, operation: Operation<*, *, *>, cacheHeaders: CacheHeaders,
    ...
    requestBuilder
        ...
        .header(
            HEADER_APOLLO_OPERATION_NAME, operation.name().name())
    ...
    if (cachePolicy.isPresent) {
      ...
      requestBuilder
          ...
          .header(
              HttpCache.CACHE_EXPIRE_TIMEOUT_HEADER, cachePolicy.expireTimeoutMs().toString())
