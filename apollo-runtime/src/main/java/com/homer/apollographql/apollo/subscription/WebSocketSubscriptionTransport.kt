package com.homer.apollographql.apollo.subscription
...
class WebSocketSubscriptionTransport @JvmOverloads constructor(
    ...
    private val callback: com.homer.apollographql.apollo.subscription.SubscriptionTransport.Callback,
  ...
  class Factory @JvmOverloads constructor(
      ...
      private val webSocketConnectionFactory: WebSocket.Factory,
      private val serializer: OperationMessageSerializer = ApolloOperationMessageSerializer
  ) : com.homer.apollographql.apollo.subscription.SubscriptionTransport.Factory {
