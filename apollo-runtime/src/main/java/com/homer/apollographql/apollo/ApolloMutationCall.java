...
public interface ApolloMutationCall<T> extends ApolloCall<T> {
  ...
  /**
   * Sets the {@link CacheHeaders} to use for this call. {@link com.homer.apollographql.apollo.interceptor.FetchOptions} will
   ...
   *                     com.homer.apollographql.apollo.cache.normalized.NormalizedCache}. Standardized cache headers are
   *                     defined in {@link com.homer.apollographql.apollo.cache.ApolloCacheHeaders}.
  ...
  interface Factory {
     ...
     *
     * Provided optimistic updates will be stored in {@link com.homer.apollographql.apollo.cache.normalized.ApolloStore}
