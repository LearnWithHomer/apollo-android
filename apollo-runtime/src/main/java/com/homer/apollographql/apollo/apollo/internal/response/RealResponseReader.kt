package com.homer.apollographql.apollo.apollo.internal.response

import com.homer.apollographql.apollo.api.BigDecimal
import com.homer.apollographql.apollo.api.CustomTypeAdapter
import com.homer.apollographql.apollo.api.CustomTypeValue.Companion.fromRawValue
...
class RealResponseReader<R>(
  ...
  override fun <T : Any> readObject(field: ResponseField, objectReader: ResponseReader.ObjectReader<T>): T? {
    ...
    parsedValue = if (value == null) {
      ...
      objectReader.read(
          RealResponseReader(operationVariables, value, fieldValueResolver, scalarTypeAdapters, resolveDelegate)
      )
    }
