...
import com.homer.apollographql.apollo.api.internal.Utils.__checkNotNull
import com.homer.apollographql.apollo.api.internal.json.InputFieldJsonWriter
import com.homer.apollographql.apollo.api.internal.json.JsonWriter.Companion.of
...
import com.homer.apollographql.apollo.interceptor.ApolloInterceptor.CallBack
import com.homer.apollographql.apollo.interceptor.ApolloInterceptor.FetchSourceType
import com.homer.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorRequest
import com.homer.apollographql.apollo.interceptor.ApolloInterceptor.InterceptorResponse
...
class ApolloServerInterceptor(serverUrl: HttpUrl, httpCallFactory: Call.Factory,
                              ...
                              scalarTypeAdapters: ScalarTypeAdapters, logger: ApolloLogger) :
    com.homer.apollographql.apollo.interceptor.ApolloInterceptor {
  ...
  override fun interceptAsync(request: InterceptorRequest, chain: com.homer.apollographql.apollo.interceptor.ApolloInterceptorChain,
  ...
  fun executeHttpCall(request: InterceptorRequest, callBack: CallBack) {
    ...
    httpCall = try {
      ...
      callBack.onFailure(
          com.homer.apollographql.apollo.exception.ApolloNetworkException(
              "Failed to prepare http call", e
          )
      )
      return
    }
  ...
  fun httpGetCall(operation: Operation<*, *, *>, cacheHeaders: CacheHeaders, requestHeaders: com.homer.apollographql.apollo.request.RequestHeaders,
  ...
  @Throws(IOException::class)
  fun httpPostCall(operation: Operation<*, *, *>, cacheHeaders: CacheHeaders, requestHeaders: com.homer.apollographql.apollo.request.RequestHeaders,
                   writeQueryDocument: Boolean, autoPersistQueries: Boolean): Call {
  ...
  fun decorateRequest(requestBuilder: Request.Builder, operation: Operation<*, *, *>, cacheHeaders: CacheHeaders,
                      requestHeaders: com.homer.apollographql.apollo.request.RequestHeaders
  ) {
    requestBuilder
  ...
  companion object {
    ...
    fun addVariablesUrlQueryParameter(urlBuilder: HttpUrl.Builder, operation: Operation<*, *, *>,
      ...
      operation.variables().marshaller().marshal(InputFieldJsonWriter(jsonWriter, scalarTypeAdapters!!))
