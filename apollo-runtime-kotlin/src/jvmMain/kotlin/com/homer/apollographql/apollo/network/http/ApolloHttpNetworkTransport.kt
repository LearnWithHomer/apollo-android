...
import com.homer.apollographql.apollo.ApolloSerializationException
  ...
  private fun <D : Operation.Data> ApolloRequest<D>.toHttpRequest(httpExecutionContext: HttpExecutionContext.Request?): Request {
    try {
      return when (httpMethod) {
        com.homer.apollographql.apollo.network.HttpMethod.Get -> toHttpGetRequest(httpExecutionContext)
        com.homer.apollographql.apollo.network.HttpMethod.Post -> toHttpPostRequest(httpExecutionContext)
      }
    } catch (e: Exception) {
