...
import com.homer.apollographql.apollo.gradle.internal.child
import com.homer.apollographql.apollo.gradle.util.TestUtils
import com.homer.apollographql.apollo.gradle.util.TestUtils.fixturesDirectory
import com.homer.apollographql.apollo.gradle.util.TestUtils.withSimpleProject
import com.homer.apollographql.apollo.gradle.util.TestUtils.withTestProject
import com.homer.apollographql.apollo.gradle.util.generatedChild
import com.homer.apollographql.apollo.gradle.util.replaceInText
...
class ConfigurationTests {
  ...
  fun `nullableValueType is working`() {
    for (pair in listOf(
        ...
        "apolloOptional" to "import com.homer.apollographql.apollo.api.internal.Optional;",
  ...
  fun `versions are enforced`() {
    withSimpleProject { dir ->
      File(dir, "build.gradle").replaceInText("dep.apollo.api", "\"com.homer.apollographql.apollo:apollo-api:1.2.0\"")
