...
import com.homer.apollographql.apollo.compiler.OperationIdGenerator
import com.homer.apollographql.apollo.compiler.OperationOutputGenerator
import com.homer.apollographql.apollo.gradle.api.ApolloAttributes
    ...
    private fun registerCompilationUnits(project: Project, apolloExtension: DefaultApolloExtension, checkVersionsTask: TaskProvider<Task>) {
      ...
      apolloVariants.all { apolloVariant ->
        ...
        compilationUnits.forEach { compilationUnit ->
          ...
          /**
           * Order matters here. See https://github.com/homer.apollographql/apollo-android/issues/1970
    ...
    fun getDeps(configurations: ConfigurationContainer): List<Dep> {
      return configurations.flatMap { configuration ->
        configuration.incoming.dependencies
            .filter {
              it.group == "com.homer.apollographql.apollo"
            }.map { dependency ->
