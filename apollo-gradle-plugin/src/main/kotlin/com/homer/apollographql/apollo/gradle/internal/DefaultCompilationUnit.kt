...
import com.homer.apollographql.apollo.gradle.api.CompilationUnit
import com.homer.apollographql.apollo.gradle.api.CompilerParams
import com.homer.apollographql.apollo.gradle.internal.ApolloPlugin.Companion.isKotlinMultiplatform
  ...
  companion object {
    ...
    private fun multipleSchemaError(): String {
      ...
      return "ApolloGraphQL: By default only one schema.[json | sdl] file is supported.\n" +
          ...
          "See https://www.homer.apollographql.com/docs/android/essentials/plugin-configuration/#apolloextension-services-and-compilationunit for more details."
    }
