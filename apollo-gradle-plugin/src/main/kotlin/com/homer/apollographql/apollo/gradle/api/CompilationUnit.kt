 ...
 * [com.homer.apollographql.apollo.gradle.internal.ApolloGenerateSourcesTask] to generate models.
 *
...
interface CompilationUnit: CompilerParams {
  ...
  /**
   * A json file containing a [Map]<[String], [com.homer.apollographql.apollo.compiler.operationoutput.OperationDescriptor]>
   */
