...
import com.homer.apollographql.apollo.gradle.internal.SchemaDownloader.cast
...
object SchemaUploader {
  ...
  """.trimIndent()
    ...
    val response = SchemaHelper.executeQuery(query, variables, "https://graphql.api.homer.apollographql.com/api/graphql", mapOf("x-api-key" to key))
