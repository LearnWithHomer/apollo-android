...
import com.homer.apollographql.apollo.api.toNumber
import okio.Buffer
...
class InputFieldJsonWriterTest {
  ...
  fun writeCustomBoolean() {
    ...
    val scalarType = MockCustomScalarType(CustomTypeValue.GraphQLBoolean::class, "com.homer.apollographql.apollo.api.CustomTypeValue.GraphQLBoolean")
  ...
  fun writeCustomNumber() {
    val customTypeAdapters: MutableMap<ScalarType, CustomTypeAdapter<*>> = HashMap()
    val scalarType = MockCustomScalarType(CustomTypeValue.GraphQLNumber::class, "com.homer.apollographql.apollo.api.CustomTypeValue.GraphQLNumber")
    customTypeAdapters[scalarType] = object : MockCustomTypeAdapter() {
      override fun encode(value: Any?): CustomTypeValue<*> {
  ...
  fun writeCustomString() {
    val customTypeAdapters: MutableMap<ScalarType, CustomTypeAdapter<*>> = HashMap()
    val scalarType = MockCustomScalarType(CustomTypeValue.GraphQLString::class, "com.homer.apollographql.apollo.api.CustomTypeValue.GraphQLString")
    customTypeAdapters[scalarType] = object : MockCustomTypeAdapter() {
      override fun encode(value: Any?): CustomTypeValue<*> {
  ...
  fun writeCustomNull() {
    val customTypeAdapters: MutableMap<ScalarType, CustomTypeAdapter<*>> = HashMap()
    val scalarType = MockCustomScalarType(CustomTypeValue.GraphQLNumber::class, "com.homer.apollographql.apollo.api.CustomTypeValue.GraphQLNull")
    customTypeAdapters[scalarType] = object : MockCustomTypeAdapter() {
      override fun encode(value: Any?): CustomTypeValue<*> {
