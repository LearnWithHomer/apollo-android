...
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token
...
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.END_ARRAY
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.END_DOCUMENT
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.END_OBJECT
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.LONG
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.NAME
...
import com.homer.apollographql.apollo.api.internal.json.JsonReader.Token.STRING
import okio.Buffer
...
class BufferedSourceJsonReader(private val source: BufferedSource) : JsonReader {
  ...
  override fun peek(): Token {
    return when (peeked.takeUnless { it == PEEKED_NONE } ?: doPeek()) {
      ...
      PEEKED_SINGLE_QUOTED_NAME, PEEKED_DOUBLE_QUOTED_NAME, PEEKED_UNQUOTED_NAME -> NAME
      PEEKED_TRUE, PEEKED_FALSE -> BOOLEAN
      PEEKED_NULL -> NULL
      PEEKED_SINGLE_QUOTED, PEEKED_DOUBLE_QUOTED, PEEKED_UNQUOTED, PEEKED_BUFFERED -> STRING
      PEEKED_LONG -> LONG
  ...
  override fun nextLong(): Long {
    ...
    when {
      ...
      p == PEEKED_DOUBLE_QUOTED || p == PEEKED_SINGLE_QUOTED -> {
        peekedString = if (p == PEEKED_DOUBLE_QUOTED) nextQuotedValue(DOUBLE_QUOTE_OR_SLASH) else nextQuotedValue(
