...
import com.homer.apollographql.apollo.api.ResponseField.Type.BOOLEAN
import com.homer.apollographql.apollo.api.ResponseField.Type.CUSTOM
import com.homer.apollographql.apollo.api.ResponseField.Type.DOUBLE
import com.homer.apollographql.apollo.api.ResponseField.Type.ENUM
import com.homer.apollographql.apollo.api.ResponseField.Type.FRAGMENT
import com.homer.apollographql.apollo.api.ResponseField.Type.INT
import com.homer.apollographql.apollo.api.ResponseField.Type.LIST
import com.homer.apollographql.apollo.api.ResponseField.Type.LONG
import com.homer.apollographql.apollo.api.ResponseField.Type.OBJECT
import com.homer.apollographql.apollo.api.ResponseField.Type.STRING
  ...
  companion object {
    ...
    fun isArgumentValueVariableType(objectMap: Map<String, Any?>): Boolean {
      return (objectMap.containsKey(VARIABLE_IDENTIFIER_KEY)
          && objectMap[VARIABLE_IDENTIFIER_KEY] == VARIABLE_IDENTIFIER_VALUE && objectMap.containsKey(
          VARIABLE_NAME_KEY
      ))
    }
  }
