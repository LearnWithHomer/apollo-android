 ...
 */
package com.homer.apollographql.apollo.cache.http.internal;
...
import static com.homer.apollographql.apollo.cache.http.internal.DiskLruCache.JOURNAL_FILE;
import static com.homer.apollographql.apollo.cache.http.internal.DiskLruCache.JOURNAL_FILE_BACKUP;
import static com.homer.apollographql.apollo.cache.http.internal.DiskLruCache.MAGIC;
import static com.homer.apollographql.apollo.cache.http.internal.DiskLruCache.VERSION_1;
...
public final class DiskLruCacheTest {
  ...
  @Test public void openWithTruncatedLineDiscardsThatLine() throws Exception {
    ...
    sink.writeUtf8(DiskLruCache.MAGIC + "\n" + DiskLruCache.VERSION_1 + "\n100\n2\n\nCLEAN k1 1 1"); // no trailing newline
    sink.close();
    createNewCache();
    assertThat(cache.get("k1")).isNull();
