...
recommended adding the following dependency explicitly: `implementation("com.homer.apollographql.apollo:apollo-normalized-cache:x.y.z")`
...
// With:
implementation("com.homer.apollographql.apollo:apollo-normalized-cache-sqlite:x.y.z") // highlight-line
```
...
The plugin ID has been changed from `com.homer.apollographql.android` to `com.homer.apollographql.apollo` to make it clear that the plugin works also
for non-Android projects. `com.homer.apollographql.android` will be removed in a future revision.

<MultiCodeBlock>

```kotlin
// Replace:
apply(plugin = "com.homer.apollographql.android")

// With:
apply(plugin = "com.homer.apollographql.apollo") // highlight-line
```
...
```kotlin
// Replace:
import com.homer.apollographql.apollo.gradle.ApolloExtension

// With:
import com.homer.apollographql.apollo.gradle.api.ApolloExtension // highlight-line
```
...
```groovy:title=build.gradle
  // Replace:
  androidTestImplementation("com.homer.apollographql.apollo:apollo-espresso-support:x.y.z")

  // With:
  androidTestImplementation("com.homer.apollographql.apollo:apollo-idling-resource:x.y.z") // highlight-line
```
