...
plugins {
    ...
    // ...
    id("com.homer.apollographql.apollo").version("2.5.9")
}
```
...
dependencies {
    // ...
    implementation("com.homer.apollographql.apollo:apollo-runtime:2.5.9")
    implementation("com.homer.apollographql.apollo:apollo-coroutines-support:2.5.9")
    // ...
}
```
