...
For this, remove the `com.homer.apollographql.apollo:apollo-runtime`dependency and replace it with:
...
`com.homer.apollographql.apollo.response.ScalarTypeAdapters`:
...
If you do have custom GraphQL scalar types, pass properly configured instance of `com.homer.apollographql.apollo.response.ScalarTypeAdapters`:
