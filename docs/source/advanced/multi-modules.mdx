...
dependencies {
    implementation("com.homer.apollographql.apollo:apollo-runtime:xyz")
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("com.homer.apollographql.apollo:apollo-api:2.5.8")
                api("com.homer.apollographql.apollo:apollo-runtime-kotlin:2.5.8")
            }
        }
    }
}
