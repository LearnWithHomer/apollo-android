...
[![apollo-idling-resource](https://img.shields.io/maven-central/v/com.homer.apollographql.apollo/apollo-idling-resource?label=apollo-idling-resource)](https://search.maven.org/artifact/com.homer.apollographql.apollo/apollo-idling-resource)
```groovy
implementation("com.homer.apollographql.apollo:apollo-idling-resource:x.y.z")
```
